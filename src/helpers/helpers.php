...
class ACLXeroHelper {
    ...
    public static function display_files( $filetype, $filter_string = '' ) {  
        ...
        ACLXeroLogger::log_message( "file_string:".$filter_string, 'xero_logging' );
    ...
    public static function xero_invoice_sync( $dry_run = false, $specific_order_ids = null ) {
        try {
            ...
            foreach ( $order_ids as $order_id ) {
                ...
                if ( $existing_invoice ) {
                    $synced_count++;
                    ACLXeroHelper::csv_file( $csv_filename, "{$order_id},{$order->get_status( )}," . print_r($invoice_id, true) . ",Already Synced", 'invoice_sync_test' );
